...
#define NUMBER_OF_SUPPORTED_FORMATS_SRC 31
#define NUMBER_OF_SUPPORTED_FORMATS_DST 32
...
static colorconvert_function colorconvert_funcArray[NUMBER_OF_SUPPORTED_FORMATS_SRC + 1][NUMBER_OF_SUPPORTED_FORMATS_DST];
